export default function About() {
  return (
      <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
          <p>
              Introducing Fileizer, the ultimate multimedia conversion powerhouse that empowers you to transform images,
